...
<div class="content-wrapper">
    <section class="content">
      ...
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="generic_form_trigger" id="profileAdd" data-url="profile">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input  type="text" value="" name="nameExtension" class="form-control" id="exampleInputEmail1" placeholder="Ex. Sr. Jr. II III">
                      </div>
                    </div>
                  </div>
